...
function StoriesBar({ currentUserId }: { currentUserId?: string }) {
  const [following, setFollowing] = useState<StoryUser[]>([]);
    ...
    <div className="flex gap-4 overflow-x-auto py-4 -mx-4 px-4 scrollbar-none border-b border-lion-gold/8">
      {following.map((user) => {
        ...
        return (
          ...
          >
            <div className="w-14 h-14 rounded-full ring-2 ring-lion-gold/30 group-hover:ring-lion-gold/70 transition-all duration-300 overflow-hidden p-0.5 bg-gradient-to-br from-lion-gold/40 to-lion-gold/10">
